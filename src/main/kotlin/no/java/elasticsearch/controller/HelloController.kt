...
import no.java.elasticsearch.service.SleepingPillService
...
class HelloController {
    ...
    @Resource
    lateinit var sleepingPillService: SleepingPillService
    ...
    fun loadFromSleepingpill() {
        elasticSearchService.storeTalksToIndex("javaZone 2098", sleepingPillService.getSessions())
    }
}